	...
	<div class="nav-top">
		<div class="top">
			<div class="py-container">
				<div class="shortcut">
					<ul class="fl">
						<li class="f-item">联创广汇商城欢迎您！</li>
					</ul>
					<ul class="fr">
						<li class="f-item"><a href="/" target="">首页</a></li><li class="f-item space"></li>
						<li class="f-item"><a href="http://www.bjlcgh.com.cn" target="_blank">企业官网</a></li><li class="f-item space"></li>
						<li class="f-item"><a href="http://www.lclot.com" target="_blank">物联网平台</a></li><li class="f-item space"></li>
						<li class="f-item"><a href="http://www.bjlcgh.com.cn" target="_blank">客户服务</a></li><li class="f-item space"></li>
						<li class="f-item"><a href="http://www.bjlcgh.com.cn" target="_blank">网站导航</a></li><li class="f-item space"></li>
						<li class="f-item"><a href="" target="_blank" ng-click="jumpMe()">个人中心</a></li><li class="f-item space"></li>
					</ul>
				</div>
			</div>
		</div>
	...
	<div class="fl price"><i>¥</i> <em>{{sku.price}}</em> <span>降价通知</span></div>
						...
						<div class="summary-wrap">
							...
							<div class="fl fix-width">
								...
								<em class="t-gray">满90000.00另加20.00元，或满19990.00另加30.00元，或满2999.00另加40.00元，即可在购物车换
购热销商品</em>
							</div>
						</div>
					</div>
					<div class="support">
						<div class="summary-wrap">
							...
							<div class="fl fix-width">
								<em class="t-gray">以旧换新，闲置回收  套餐超值抢  礼品购</em>
							</div>
						</div>
						<div class="summary-wrap">
							<div class="fl title">
							...
							<div class="fl fix-width">
								<em class="t-gray">全国31省下辖所有行政市、县均可送货、发货、快递、物流！</em>
							</div>
						</div>
					</div>
...
<div class="controls">
	...
	<a href="javascript:void(0)" class="increment mins" ng-click="addNum(-1)">-</a>
							...
							<div class="fl">
								...
								<li><a href="#" target="_self" class="sui-btn  btn-danger addshopcar" ng-click="addToCart()">加入购物车</a></li>
								</ul>
							</div>
						</div>
					</div>
    ...
    <input type="checkbox"><span>￥5299</span>
  </label>
									</li>
									<li class="">
						...
						<div class="tab-content tab-wraped">
							<div id="one" class="tab-pane active">
								<ul class="goods-intro unstyled">
									<li>北京联创广汇电气制造有限公司</li>
									<li>如果有任何问题，欢迎通过以下任意方式联系我们：</li>
									<li>全国咨询电话：010-59777836 / 59777837 （工作日：08:00-17：00）</li>
									<li>电话传真：010-59777839</li>
									<li>售后服务电话：010-59777836转分机822</li>
									<li>投诉电话：010-59777838</li>
									<li>电子邮件：sales@bjlcgh.com.cn </li>
									<li>企业QQ号：2991313446（工作日在线时间：08:00-17：00）</li>
									<li>企业微信公众号：bjlcgh</li>
									<li>公司地址：北京市中关村科技园通州园景盛南四街甲13号1i</li>
								</ul>
